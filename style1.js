...
function addToCart(event){
    ...
    <td class="uk-table-link">
        <h3 class = "item-name">RS{itemName}</h3>
    </td>
    <td class="uk-text-truncate item-price"><h3>RS{itemPrice}</h3></td>
    <td><input type = 'number' class = 'num' value = '1'></td>
    <td class="uk-text-truncate total-price"><h3>RS{itemPrice}</h3></td>
